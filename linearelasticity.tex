...
% Title Page
\title{Linear Elasticity and Crack Modelling in 2D and 3D\\ Using Finite Element Method}
...
\end{figure}
\newpage
\section{Elasticity with Crack Problem}
Below is the graph of Linear Elasticity Problem with Crack Model in 2D.
\begin{figure}[h!]
	\begin{subfigure}[b]{0.5\linewidth}
		\centering
		\includegraphics[width=\linewidth]{picture/conference/2dcrack}
		\caption{Elasticity with Crack Problem Model in 2D}
		\label{fig:2dcrack}
	\end{subfigure}
	\quad
	\begin{subfigure}[b]{0.5\linewidth}
		\centering
		\includegraphics[width=\linewidth]{picture/conference/2dcrackfinal}
		\caption{Calculated $\sigma$ on 2D crack case. The value of $\sigma$ on the domain, maped by the color in the picture with respect to the color palette on the lower side of the graph. Maximal stress given on the surface ($\sigma = 100.921\ [GPa]$)}
		\label{fig:2dcrackfinal}
	\end{subfigure}
	\caption{Elasticity with Crack Problem in 2D}
	\label{fig:crackmodel}
\end{figure}
\newline
From figure \ref{fig:crackmodel}, we calculated the elastic energy through various length of crack, below is the result of the energy profile from our model in \ref{fig:crackmodel}.
\begin{figure}[h!]
	\centering
